def check_ticket(ticket):
    ...
    for match_symbol in winning_symbols:
        for uninterrupted_match_length in range(10, 5, -1):
            winning_symbols_repetitions = match_symbol * uninterrupted_match_length
            if winning_symbols_repetitions in left_part and winning_symbols_repetitions in right_part:
